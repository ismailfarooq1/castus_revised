<x-app-layout>
    ...
    <div id="products">
        <div class="container mx-auto mt-16">
            ...
            <h2 class="text-3xl my-12">All Products</h2>
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            {{ ($product->is_rental) ? 'Yes' : 'No' }}
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap flex">
                                            <a href="{{ route('products.edit', [$product]) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded text-xs mr-2">Edit</a>
