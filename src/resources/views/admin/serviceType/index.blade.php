<x-app-layout>
    ...
    <div id="products">
        <div class="container mx-auto mt-16">
            ...
            <h2 class="text-3xl my-12">All Service Types</h2>
            <a href="{{ route('serviceTypes.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add new Service Type</a>
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            {{ $serviceType->short_description }}
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            {{ $serviceType->created_at }}
                                        </td>
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap flex">
                                            <a href="{{ route('serviceTypes.edit', [$serviceType]) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded text-xs mr-2">Edit</a>
